...
"""
accelerate launch SFT/sft_llama2.py \
...
class ScriptArguments:
    ...
    lora_r: Optional[int] = field(default=1, metadata={"help": "the lora r parameter"})
...
tokenizer = AutoTokenizer.from_pretrained(script_args.model_name, token=access_token, trust_remote_code=True)
